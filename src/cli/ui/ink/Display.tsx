...
interface DisplayProps {
  type?: 'text' | 'success' | 'error' | 'warning' | 'info' | 'header' | 'section' | 'code' | 'quote' | 'separator' | 'highlight' | 'step' | 'spinner';
  content: string;
  ...
  const renderContent = () => {
    switch (type) {
      ...
      case 'step':
        ...
        return (
          <Text>
            <Text color={theme.colors.info}>[{stepInfo.current}/{stepInfo.total}]</Text> {formatText(content, options)}
          </Text>
        );
