 ...
 */
function renderHastNode(node: any, syntaxColors: SyntaxColors, key: number = 0): React.ReactNode {
  if (node.type === 'text') {
 ...
 * 高亮单行代码
 */
function highlightLine(line: string, language?: string, syntaxColors?: SyntaxColors): React.ReactNode {
