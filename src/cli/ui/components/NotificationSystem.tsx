...
export const useNotify = () => {
  ...
  const notify = {
    info: (title: string, message: string, options?: Partial<Omit<ReturnType<typeof useNotifications>['notifications'][0], 'id' | 'timestamp' | 'type' | 'title' | 'message'>>) => {
      addNotification({
        type: 'info',
        title,
        message,
    ...
    success: (title: string, message: string, options?: Partial<Omit<ReturnType<typeof useNotifications>['notifications'][0], 'id' | 'timestamp' | 'type' | 'title' | 'message'>>) => {
      addNotification({
        type: 'success',
        title,
        message,
    ...
    warning: (title: string, message: string, options?: Partial<Omit<ReturnType<typeof useNotifications>['notifications'][0], 'id' | 'timestamp' | 'type' | 'title' | 'message'>>) => {
      addNotification({
        type: 'warning',
        title,
        message,
    ...
    error: (title: string, message: string, options?: Partial<Omit<ReturnType<typeof useNotifications>['notifications'][0], 'id' | 'timestamp' | 'type' | 'title' | 'message'>>) => {
      addNotification({
        type: 'error',
        title,
        message,
