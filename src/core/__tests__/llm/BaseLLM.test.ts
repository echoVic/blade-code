...
describe('BaseLLM', () => {
  ...
  describe('聊天功能', () => {
    ...
    test('应该在聊天错误时正确处理', async () => {
      jest.spyOn(mockLLM as any, '_chat').mockRejectedValueOnce(new Error('Chat Error'));
  ...
  describe('文本补全', () => {
    ...
    test('应该在补全错误时正确处理', async () => {
      jest.spyOn(mockLLM as any, '_complete').mockRejectedValueOnce(new Error('Complete Error'));
  ...
  describe('嵌入生成', () => {
    ...
    test('应该在嵌入错误时正确处理', async () => {
      jest.spyOn(mockLLM as any, '_embed').mockRejectedValueOnce(new Error('Embed Error'));
  ...
  describe('统计信息', () => {
    ...
    test('应该跟踪错误统计', async () => {
      jest.spyOn(mockLLM as any, '_chat').mockRejectedValueOnce(new Error('Test Error'));
  ...
  describe('错误处理', () => {
    test('应该在销毁后拒绝调用方法', async () => {
      ...
      await expect(mockLLM.complete('Hello')).rejects.toThrow('LLM instance is destroyed');
      await expect(mockLLM.embed(['Hello'])).rejects.toThrow('LLM instance is destroyed');
    });
