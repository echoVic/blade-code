...
~/.blade/
├── projects/
│   ├── -Users-bytedance-Documents-GitHub-Blade/  # 项目目录（路径转义）
│   │   ├── {sessionId}.jsonl                      # 会话文件
│   │   ├── {sessionId2}.jsonl
│   │   └── ...
│   └── -Users-bytedance-other-project/
│       └── ...
...
- `/` → `-`
- `/Users/bytedance/Documents/GitHub/Blade` → `-Users-bytedance-Documents-GitHub-Blade`
