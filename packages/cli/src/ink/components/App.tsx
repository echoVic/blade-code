...
const logForDebugging = (..._args: unknown[]) => {};
const stopCapturingEarlyInput = () => {};
const isEnvTruthy = (v: string | undefined) => v === '1' || v === 'true';
...
export default class App extends PureComponent<Props, State> {
  ...
  override componentDidMount() {
    ...
    if (this.props.stdout.isTTY && !isEnvTruthy(process.env.BLADE_ACCESSIBILITY)) {
  ...
  handleSuspend = (): void => {
    ...
    const resumeHandler = () => {
      ...
      if (this.props.stdout.isTTY) {
        if (!isEnvTruthy(process.env.BLADE_ACCESSIBILITY)) {
          this.props.stdout.write(HIDE_CURSOR);
        }
