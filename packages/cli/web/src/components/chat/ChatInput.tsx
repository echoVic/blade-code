...
export function ChatInput({ onSend, onAbort, disabled, isStreaming }: ChatInputProps) {
  ...
  }, [attachments, input, disabled, onSend, inputHistory]);
          ...
          {attachments.length > 0 && (
            <div className="px-4 pb-2 flex flex-wrap gap-2">
              {attachments.map((attachment) => (
                <div
                  key={attachment.id}
                  className="relative rounded-md overflow-hidden border border-[#E5E7EB] dark:border-zinc-800 bg-[#F9FAFB] dark:bg-zinc-900"
                >
                  <img
          ...
          <div className="flex justify-between items-center p-3 mt-auto">
            <div className="flex gap-2 items-center">
              ...
              <Button
                ...
                className="h-8 w-8 text-[#9CA3AF] hover:text-[#111827] hover:bg-[#E5E7EB] dark:text-zinc-500 dark:hover:text-zinc-300 dark:hover:bg-zinc-800/50"
              >
