...
describe('FileSystemService', () => {
  ...
  it('should copy file', async () => {
    ...
    expect(fs.mkdir).toHaveBeenCalledWith(path.dirname('/dest/file.txt'), {
      recursive: true,
    });
  ...
  it('should create directory', async () => {
    ...
    expect(fs.mkdir).toHaveBeenCalledWith('/test/new-directory', {
      recursive: undefined,
    });
  });
  ...
  it('should delete directory', async () => {
    ...
    expect(fs.rm).toHaveBeenCalledWith('/test/directory', {
      recursive: undefined,
      force: undefined,
    });
  });
